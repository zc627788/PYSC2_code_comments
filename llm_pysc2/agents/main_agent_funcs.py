...
def get_camera_func_smart(self, obs, tag, threshold=0.15, team=None):
  ...
  Returns:
      tuple: (func_id, func_call) 函数ID和调用
              ...
              func_id=0: 无需移动
  """
  unit_r = None  # 在raw_units中找到的单位
  unit_f = None  # 在feature_units中找到的单位
...
def main_agent_func0(self, obs):
  ...
  Returns:
      FunctionCall: PySC2可执行的游戏动作，如果不需要执行动作则返回None
  """
