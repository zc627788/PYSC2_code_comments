...
DATA_ZERG = {
    ...
    units.Zerg.ZerglingBurrowed: {
        ...
        'name_cn': '埋地跳虫',
        # wiki英文 Details
        'description': 'Burrowed zergling. Cannot attack or move. Can be unburrowed to attack or move.',
        'target': ['ground'],
        'target_self': ['ground'],
        # wiki中文 基本信息/属性
        # biological生物/mechanical机械/psionic灵能/light轻甲/armored重甲/massive巨型/structure建筑
    ...
    units.Zerg.RoachBurrowed: {
        # wiki英文 Unit
        'name': 'RoachBurrowed',
        'name_cn': '埋地蟑螂',
        # wiki英文 Details
        'description': 'Burrowed roach. Cannot attack or move. Can be unburrowed to attack or move.',
    ...
    units.Zerg.Infestor: {
        ...
        'ability': {  # wiki英文 作战/技能，只记录主动技能
            ...
            'Infested Terran': 'Always available.'
                               'Spawns an Infested Swarm Egg, which takes 5 seconds to hatch an Infested Terran. '
                               'cost 25 energy,range 8,duration 21 seconds.'
        },
    ...
    units.Zerg.InfestorBurrowed: {
        ...
        'produce_cost_gas': 0,  # wiki中文 生产/成本，瓦斯(绿色)
        'produce_from': 'burrow from Infestor.',  # wiki中文 生产/生产设施
        ...
        'require_building': 'have Infestation Pit',
        'require_tech': '',
        'require_unit': 'Burrow 1 Infestor',
    ...
    units.Zerg.InfestedTerran: {
        ...
        'name_cn': '被感染的人类',
        # wiki英文 Details
        'description': 'Produced from Infestor.Life span 21 seconds。',
        'target_self': ['ground'],
        # wiki中文 基本信息/属性
        # biological生物/mechanical机械/psionic灵能/light轻甲/armored重甲/massive巨型/structure建筑
        'type_self': ['light', 'biological'],
        ...
        'produce_cost_mineral': 0,  # wiki中文 生产/成本，水晶(蓝色)
        'produce_cost_gas': 0,  # wiki中文 生产/成本，瓦斯(绿色)
        'produce_from': 'produced by InfestedSwarmEgg.',  # wiki中文 生产/生产设施
