...
flags.DEFINE_enum("difficulty", "very_hard", sc2_env.Difficulty._member_names_,  # pylint: disable=protected-access
                  "If agent2 is a built-in Bot, it's strength.")
...
def main(unused_argv):
  ...
  # print(f"map_inst.players = {map_inst.players}")
  # print(f"FLAGS.agent2 = {FLAGS.agent2}")
  # input()
